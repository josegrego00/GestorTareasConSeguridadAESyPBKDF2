...
public class VistaNuevaTarea extends javax.swing.JDialog {
    ...
    private void cargarDatosTarea() {
        ...
        if (tareaEditar.getFechaLimite() != null) {
            txtFechaLimite.setText(sdf.format(tareaEditar.getFechaLimite()));
        }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Fecha límite (dd/MM/yyyy):");
                                                ...
                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                        ...
                                                        .addGroup(layout.createSequentialGroup()
                                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                                        ...
                                                                        .addComponent(txtFechaLimite, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE))
                                                                .addGap(18, 18, 18)
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            if (!txtFechaLimite.getText().trim().isEmpty()) {
                SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
                fechaLimite = sdf.parse(txtFechaLimite.getText().trim());
            }
